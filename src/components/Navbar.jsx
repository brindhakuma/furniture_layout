    ...
    >
      ...
      >
        ...
        <div style={{ gap: "35px", display: "flex" }}>
          ...
          <Link to="/home" style={linkStyle}>Categories</Link>
        ...
        <div style={{ gap: "35px", display: "flex", position: "relative" }}>
          ...
          {!isLoggedIn ? (
            ...
            <>
              ...
              {/* Cart */}
              <Link to="/cart">
                <img src={cart} alt="cart" width="40" style={iconStyle} />
              </Link>

              {/* Wishlist */}
              <Link to="/whislist/2/">
                <img src={heart} alt="wishlist" width="40" style={iconStyle} />
              </Link>
              ...
              <div style={{ position: "relative" }}>
                ...
                {showProfile && (
                  <div style={profileBox}>
                    <h3 onClick={() => navigate("/myaccount")}>My Account</h3>
                    <p onClick={() => navigate("/myorder")}>My Orders</p>
                    <p onClick={() => navigate("/password")}>Password Manager</p>
                    <p
                      onClick={() => {
                        localStorage.removeItem("token");
